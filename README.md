...
The purpose of this project is to calculate the population branch statistic between maize and teosinte using tripsicum as an outgroup using data from Lemmon et al.
